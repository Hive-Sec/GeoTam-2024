...
def show_main_window():
    root.destroy()
    main_window = tk.Tk()
    main_window.title("Hive c0re Application")
    ...
    menubar.add_cascade(label="Feed Data Set", menu=file_menu)
...
# Create a welcome window no fancy stuff 
root = tk.Tk()
root.title("Welcome to Hives GEOTAM Lab")
...
welcome_text = '''Welcome to the GEOTAM Hackathon APP 2024
By c00kie from Hive Sec'''
